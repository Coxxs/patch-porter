import * as lz4 from './lz4.mjs'

import { toHex } from './buffer-utils.mjs'
 ...
 */
export function getNsobid(buffer) {
  let nsobid = toHex(buffer.subarray(0x40, 0x40 + 0x20))
  ...
  function getRawSegment(buffer, metadata) {
    ...
    if (metadata.compressed) {
      try {
        ...
        const tempDataView = new DataView(tempBuffer.buffer, tempBuffer.byteOffset, tempBuffer.byteLength)
